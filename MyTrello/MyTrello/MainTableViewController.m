...
- (void)viewDidLoad {
    ...
    NSLog(@"Le token est : %@", [self token]);
    // REQUETE
    
    NSString *urltoken = [NSString stringWithFormat: @"https://api.trello.com/1/member/me/boards?token=%@&key=1750ece02327997692ab493e0d299767", ];
